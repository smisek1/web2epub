...
9	phys.org	https://phys.org/tags/quantum/	//article[@class="news-article"]/h1/text()	//article[@class="news-article"]/div[@class="mt-4 article-main"]/node()	//body//a[@class="news-link"]/@href	normalize-space((//article[@class="news-article"]//p[@class="text-uppercase text-low"])[1]/text()[1])	\N	normalize-space((//article[@class="news-article"]//p[contains(@class,"article-byline")])[1])
